...
class PowerOfWorshipViewController:  UIViewController, AVAudioPlayerDelegate{
    ...
    @objc func handleUpdateChannel () {



            self.loadCurrentChurch(codigo: advengers.shared.currenUSer["churchID"] as? String ?? "")
            self.loadActiveChannel(codigo: advengers.shared.currentChurchInfo.channelActive)
    ...
    override func viewDidLoad() {
      //  audioPlayer?.delegate = self
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(handleUpdateChannel), name: NSNotification.Name(rawValue: "updateChannel"), object: nil)
