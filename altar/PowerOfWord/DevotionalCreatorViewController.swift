...
*/
        ...
        devText.attributedText = NSAttributedString(string: NSLocalizedString("Add your devotional here...", comment: ""), attributes: attributes)
...
extension DevotionalCreatorViewController: UITextViewDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
      //  scroll.setContentOffset(CGPoint(x: 0, y: (textView.superview?.frame.origin.y)!), animated: true)
        ...
        if textView.text == NSLocalizedString("Add your devotional here...", comment: "") {
            let attributes = [
...
extension DevotionalCreatorViewController: UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField.text == NSLocalizedString("Change title here ...", comment: "") {
        textField.text = ""
        }
    }
