//
//  EditChurchProfileViewController.swift
//  altar
//
//  Created by Juan Moreno on 3/6/20.
...
//
    ...
    class EditChurchProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
                    ...
                    self.accounthelper.loadCurrentChurch(codigo: advengers.shared.currenUSer["churchID"] as! String,completionHandler: { (success) -> Void in
                        ...
                        if success {
                            ...
                            if advengers.shared.currentChurchInfo.userID != Auth.auth().currentUser?.uid {
                                ...
                                self.creatProfile.isEnabled = false
                                self.creatProfile.alpha = 0.5
                                self.errorLabel.text = "Only account owner can edit this info."
