...
class AudibleViewController: UIViewController, AVAudioRecorderDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        imageView.frame = CGRect(x: 0, y: 0, width: view.frame.width - 100 , height: (view.frame.width / ratio) - 100)
     ...
     //   view.addSubview(postRercord)
        ...
        viewToRercord.anchor(top: userProfileImageView.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 10, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: (view.frame.width) - 100 , height: (view.frame.width / ratio) - 100)
        viewToRercord.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        
        
        playRercord.anchor(top: viewToRercord.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 6, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 73, height: 73)
        ...
        PlayLalel.text = NSLocalizedString("Touch and hold the red button to record audio message", comment: "")
