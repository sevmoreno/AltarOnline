...
class CreateEventViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titulo.text = NSLocalizedString("Change title here ...", comment: "")
        devText.tag = 200
        ...
        if devocionalRichText.isEmpty {
            ...
            devText.attributedText = NSAttributedString(string: NSLocalizedString("Add your event here...", comment: ""), attributes: attributes)
...
extension CreateEventViewController: UITextViewDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        ...
        if textView.tag == 200 {
            ...
            if textView.attributedText.string == NSLocalizedString("Add your event here...", comment: "") {
        ...
        if textView.tag == 100 {
            ...
            if textView.text == NSLocalizedString("Change title here ...", comment: "") {
