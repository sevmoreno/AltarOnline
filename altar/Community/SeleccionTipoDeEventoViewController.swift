//
//  SeleccionTipoDeEventoViewController.swift
//  Favorday
//
...
class SeleccionTipoDeEventoViewController: UIViewController {
        ...
        let conTexto: UIButton = {
            ...
            a.setTitle(NSLocalizedString("Add Event", comment: ""), for: .normal)
       //     a.alignmentRectInsets = 2
           ...
           let conVideo: UIButton = {
               ...
               a.setTitle(NSLocalizedString("Add Live Video Stream", comment: ""), for: .normal)
          //     a.alignmentRectInsets = 2
        ...
        @objc func iratexto () {
            ...
            performSegue(withIdentifier: "eventoTexto", sender: self)
        ...
        @objc func iraVideo () {
            ...
            performSegue(withIdentifier: "aVideoLink", sender: self)
