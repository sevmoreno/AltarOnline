...
class VideoResultcolCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        songImageView.anchor(top: nil, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 170, height: 140)
       
        Title.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 3, paddingRight: 8, width: 0, height: 0)
        Title.font = UIFont(name: "Avenir-Heavy",size: 15)
        Title.textColor = .white
        Title.backgroundColor = advengers.shared.colorBlue
